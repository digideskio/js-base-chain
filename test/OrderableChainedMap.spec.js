...
describe('.delete', () => {
    it('should delete the entry from the order store', () => {
        ...
        map.order('foo', ({ before }) => before('bar'));
        map.delete('foo');
...
describe('.values', () => {
    it('should return the entry values by insertion order', () => {
        ...
        map.order('prop1', ({ after }) => after('prop3'));
        map.order('prop2', ({ before }) => before('prop1'));
    ...
    it('should deal with relative keys that does not exist', () => {
        ...
        map.order('prop1', ({ after }) => after('prop4'));
        map.order('prop2', ({ before }) => before('prop5'));
